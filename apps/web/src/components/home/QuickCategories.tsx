...
const CATEGORIES = [
	{ icon: "directions_run", label: "Running", slug: "running", active: true },
	{ icon: "checkroom", label: "Lifestyle", slug: "lifestyle", active: false },
	{
	...
	{ icon: "hiking", label: "Outdoor", slug: "outdoor", active: false },
	{ icon: "skateboarding", label: "Skate", slug: "skate", active: false },
];
